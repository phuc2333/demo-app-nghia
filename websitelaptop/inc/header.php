...
<body>
  <div class="wrap">
		<div class="header_top">
			<div class="logo">
				<a href="index.php"><img src="admin/img/logo.jpg" height="100px" alt="" /></a>
			</div>
			  <div class="header_top_right">
			    <div class="search_box">
				    <form  action="index.php?quanly=timkiem" method="GET">
			         <input type="text" name="tukhoa" placeholder="Tìm kiếm sản phẩm"><input type="submit" name="timkiem" value="SEARCH">
				    </form>
